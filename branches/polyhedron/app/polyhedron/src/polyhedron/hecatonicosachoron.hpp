...
#ifndef _ARAGELI_APP_POLYHEDRON_hecatonicosachoron_hpp_
#define _ARAGELI_APP_POLYHEDRON_hecatonicosachoron_hpp_
...
// 120-cell
class Hecatonicosachoron : public Processor
{
