...
#ifndef _ARAGELI_APP_POLYHEDRON_icositetrachoron_hpp_
#define _ARAGELI_APP_POLYHEDRON_icositetrachoron_hpp_
...
// 24-cell
class Icositetrachoron : public Processor
{
